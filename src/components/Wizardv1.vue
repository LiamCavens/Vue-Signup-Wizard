<template>
    <div class="wizard">
        <div>
            ...
            <p v-if="pet.age && stage >= 5">
                ...
                <span v-if="pet.weight && stage >= 6">
                    and weigh
                    <span class="bold">{{ pet.weight }}kg</span> </span
                >.
            </p>
            <p v-if="stage >= 7">
                In temperment, I'm
                <span class="bold" v-if="pet.activity === 'potato'"
                    >a bit of a couch potato</span
                >
                <span class="bold" v-if="pet.activity === 'notso'"
                    >not very active</span
                >
                <span class="bold" v-if="pet.activity === 'active'"
                    >an active dog</span
                >
                <span class="bold" v-if="pet.activity === 'more'"
                    >more active than most</span
                >
                <span class="bold" v-if="pet.activity === 'super'"
                    >super active</span
                >

                <span v-if="stage >= 8">
                    and
                    <span class="bold" v-if="pet.body === 'underweight'"
                        >very underweight</span
                    >
                    <span class="bold" v-if="pet.body === 'slightlyunder'"
                        >slightly underweight</span
                    >
                    <span class="bold" v-if="pet.body === 'average'"
                        >average</span
                    >
                    <span class="bold" v-if="pet.body === 'slightlyover'"
                        >slightly overweight</span
                    >
                    <span class="bold" v-if="pet.body === 'overweight'"
                        >very overweight</span
                    >
                </span>
            </p>
            <p v-if="stage >= 9">
        ...
        <div class="question-form">
            ...
            <form v-if="stage === 8">
                <button v-on:click="handleWorkingDog(false)">
                    Not a Working Dog
                </button>
                <button v-on:click="handleWorkingDog(true)">
                    Working Dog
                </button>
            </form>
            <form
                class="wizard-health"
                v-if="stage === 9"
                v-on:submit.prevent="doPhysical"
            >
                <ul class="wizard-list">
                    ...
                    <li>
                        ...
                        />
                        <label for="health4"
                            >Digestive Problems (IBS/IBD)</label
                        >
                    </li>
                    <li>
                        <input
            ...
            <form
                class="wizard-health"
                v-if="stage === 10"
                v-on:submit.prevent="doBehavioral"
            >
                <ul class="wizard-list">
                    <li>
                        <input
                    ...
                    <li>
                        ...
                        />
                        <label for="health15"
                            >Fearful of Fireworks or Thunderstorms</label
                        >
                    </li>
                    <li>
                        <input
            ...
            <form v-if="stage === 13">
                ...
                <button v-on:click="handleRawExperience('occasional')">
                    Occasional
                </button>
                <button v-on:click="handleRawExperience('experienced')">
                    Experienced
                </button>
            </form>
        </div>
